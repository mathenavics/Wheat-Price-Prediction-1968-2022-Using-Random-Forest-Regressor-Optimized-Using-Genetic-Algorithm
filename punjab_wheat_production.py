# -*- coding: utf-8 -*-
"""Punjab_Wheat_Production.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1NY4_I44CTU-J_uvsae5uxEGKYpAyRRU0
"""
...
def compare_metrics(names_models_train:dict,
    ...
    def autolabel_test(rects):
      ...
      for rect in rects:
          height = rect.get_height()
ax[1].annotate('{}'.format(height),                      xy=(rect.get_x() + rect.get_width() / 2, height-0.005),
                      xytext=(0, 3),
                      textcoords="offset points",
                      ha='center', va='bottom', size = 7, weight = 'bold')
...
forward_selector = SequentialFeatureSelector(base_model,n_features_to_select=20, direction='forward',scoring='neg_mean_squared_error',cv=None)
